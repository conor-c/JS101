...
// get the first number to be added
...
// --SET first number to variable 1
// GET the second number
// --SET second number to variable 2
...
//    if the index is divisble by 2, skip to the next element
//    is the index of the element is odd, assign it to the new array variable
